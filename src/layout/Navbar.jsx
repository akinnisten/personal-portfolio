...
export const Navbar = () => {
    ...
    return (
        ...
        >
            <nav className="container mx-auto px-6 flex items-center justify-between max-w-6xl">
                ...
                <div className="hidden md:flex items-center gap-8">
                    {navLinks.map((link) => (
                        ...
                        >
                            {/* Keep the number distinct with mono, but keep size consistent */}
                            <span className="text-primary font-mono text-xs">
                                {link.number}
                            </span>
                            {/* Standard text-sm and regular weight to match your body text */}
            ...
            {/* Mobile Menu Overlay */}
            {isMobileMenuOpen && (
                <div className="fixed inset-0 top-[70px] bg-background/95 backdrop-blur-xl z-40 md:hidden animate-in fade-in slide-in-from-top-4 duration-300">
